...
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { input_confer }]; #IO_25_34 Sch=sw[9]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { error }]; #IO_L16N_T2_A15_D31_14 Sch=led[8]
