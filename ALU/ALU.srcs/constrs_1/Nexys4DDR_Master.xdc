...
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { newclk }]; #IO_L17P_T2_A14_D30_14 Sch=led[6]
...
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { f[3] }]; #IO_L14N_T2_SRCC_14 Sch=led[9]
